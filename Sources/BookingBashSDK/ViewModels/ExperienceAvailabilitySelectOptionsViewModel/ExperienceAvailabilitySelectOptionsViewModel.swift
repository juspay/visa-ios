...
class ExperienceAvailabilitySelectOptionsViewModel: ObservableObject {
    @Published var selectedDate: String = "19 Jul 2025"
...
//            infoItems: [
//                .init(title: "Pickup included", icon: "car.fill"),
//                .init(title: "Instant confirmation", icon: "bolt.fill"),
//                .init(title: "Guide included", icon: "person.2.fill")
//            ],
//            pricingDescription: [
//                "2 Adults x AED 295",
//                "1 Child x AED 295"
...
extension ExperienceAvailabilitySelectOptionsViewModel {
    ...
    func fetchAvailabilities(productCode: String, currencyCode: String) {
        guard let url = URL(string: "https://bookyourvoyagesit.vetravel.io/api/activities/2.0/availability") else { return }
        ...
        NetworkManager.shared.post(url: url, body: requestBody) { (result: Result<AvailabilityApiResponse, Error>) in
