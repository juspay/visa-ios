...
//            ExperienceCheckoutView(viewModel: ExperienceAvailabilitySelectOptionsViewModel())
//        }
//    }
//}
...
struct ExperiencePassesCardView: View {
    ...
    var body: some View {
        ...
        .navigation(isActive: $shouldNavigate, id: Constants.NavigationId.experienceCheckoutView) {
            ExperienceCheckoutView(viewModel: ExperienceAvailabilitySelectOptionsViewModel(), package: package)
        }
}
}
